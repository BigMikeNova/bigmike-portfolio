        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <p className='text-center'>An API Linking App for Finding Breweries in your city on a nice day</p>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <p className='text-center'>A barebones social media site for recipe sharing</p>
              <div className='pt-8 text-center'>
          ...
          <div
            style={{ backgroundImage: `url(${cheatSheet})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <p className='text-center'>A cheatsheet for new coders to learn CSS</p>
              <div className='pt-8 text-center'>
                <a href='https://bigmikenova.github.io/CSS-Snippet-Cheatsheet/'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a href='https://github.com/BigMikeNova/CSS-Snippet-Cheatsheet'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
